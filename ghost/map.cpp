...
CMap :: CMap( CGHost *nGHost, CConfig *CFG, string nCFGFile, unsigned char nMaxSlots ) : m_GHost( nGHost ), m_MaxSlots(nMaxSlots)
{
	Load( CFG, nCFGFile );
}
